! function() {
    ...
    function d() {
        n.select(".datamaps-style-block").empty() && n.select("head").append("style").attr("class", "datamaps-style-block").html('.datamap path.datamaps-graticule { fill: none; stroke: #777; stroke-width: 0.5px; stroke-opacity: .5; pointer-events: none; } .datamap .labels {pointer-events: none;} .datamap path:not(.datamaps-arc), .datamap circle, .datamap line {stroke: #FFFFFF; vector-effect: non-scaling-stroke; stroke-width: 1px;} .datamaps-legend dt, .datamaps-legend dd { float: left; margin: 0 3px 0 0;} .datamaps-legend dd {width: 20px; margin-right: 6px; border-radius: 3px;} .datamaps-legend {padding-bottom: 20px; z-index: 1001; position: absolute; left: 4px; font-size: 12px; font-family: "Helvetica Neue", Helvetica, Arial, sans-serif;} .datamaps-hoverover {display: none; font-family: "Helvetica Neue", Helvetica, Arial, sans-serif; } .hoverinfo {padding: 0; border-radius: 0; background-color: #FFF; box-shadow: 0 5px 15px rgba(0, 0, 0, 0.5); font-size: 12px; border: none; } .hoverinfo hr {border: none; } .hoverinfo:after, .hoverinfo:before { top: 100%; left: 50%; border: solid transparent; content: " "; height: 0; width: 0; position: absolute; pointer-events: none; } .hoverinfo:after { border-color: rgba(255, 255, 255, 0); border-top-color: #ffffff; border-width: 30px; margin-left: -30px; } .hoverinfo:before { border-color: rgba(0, 0, 0, 0); border-top-color: none; border-width: 36px; margin-left: -36px; }');
    }
    ...
    function i(b, c, d) {
        ...
        h.enter().append("svg:path").attr("class", "datamaps-arc").style("stroke-linecap", "round").style("stroke", function(b) {
            ...
            var c, g;
            c = "string" == typeof b.origin ? e.path.centroid(f.select("path." + b.origin).data()[0]) : e.latLngToXY(a(b.origin.latitude, b), a(b.origin.longitude, b)), g = "string" == typeof b.destination ? e.path.centroid(f.select("path." + b.destination).data()[0]) : e.latLngToXY(a(b.destination.latitude, b), a(b.destination.longitude, b));
    ...
    function k(b, c, d) {
        ...
        j.enter().append("svg:circle").attr("class", "datamaps-bubble").attr("cx", function(a) {
            var b;
            return e(a) ? b = f.latLngToXY(a.latitude, a.longitude) : a.centered && (b = "USA" === a.centered ? f.projection([-98.58333, 39.83333]) : f.path.centroid(i.select("path." + a.centered).data()[0])), b ? b[0] : void 0
        }).attr("cy", function(a) {
            var b;
            return e(a) ? b = f.latLngToXY(a.latitude, a.longitude) : a.centered && (b = "USA" === a.centered ? f.projection([-98.58333, 39.83333]) : f.path.centroid(i.select("path." + a.centered).data()[0])), b ? b[1] : void 0
        }).attr("r", function(b) {
    ...
    var n = window.d3,
        ...
        p = {
            ...
            geographyConfig: {
                ...
                popupOnHover: !0,
                highlightOnHover: !0,
                highlightFillColor: "#8EC73F",
                highlightBorderColor: "#8EC73F",
